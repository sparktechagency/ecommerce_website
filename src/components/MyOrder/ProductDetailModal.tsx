...
// // // Inline Order types to avoid external files
// // interface OrderItem {
// //   id: string;
// //   productName: string;
// //   price: number;
...
// //   handleOk: () => void;
// //   handleCancel: () => void;
// //   order?: Order; // may be undefined initially
// // }
...
// //                     {(item.quantity ?? 0).toString().padStart(2, "0")}
// //                   </div>
// //                   <div className="text-sm sm:text-base">${item.price ?? 0}</div>
